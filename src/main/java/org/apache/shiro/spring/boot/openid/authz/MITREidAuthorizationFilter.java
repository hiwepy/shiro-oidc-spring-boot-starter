 ...
 */
public class MITREidAuthorizationFilter extends AbstracAuthorizationFilter {

	private static final Logger LOG = LoggerFactory.getLogger(MITREidAuthorizationFilter.class);
